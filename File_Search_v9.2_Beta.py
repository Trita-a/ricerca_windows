...
class FileSearchApp:
    ...
    def create_widgets(self):
        ...
        # Nuovo pulsante per le opzioni di performance
        self.perf_options_btn = ttk.Button(advanced_frame, text="Performance", 
                                        command=self.show_performance_options, width=15)
        self.perf_options_btn.pack(side=LEFT, padx=5)
        self.create_tooltip(self.perf_options_btn, "Configura le opzioni di performance, timeout e limiti della ricerca")
                
        # ------------------------------------------------------
        # RIGA 5: Pulsanti di azione
        # ------------------------------------------------------
